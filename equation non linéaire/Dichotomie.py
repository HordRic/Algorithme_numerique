...
def madichotomie(f, a, b, precision, nmax):
    ...
    if f(a) * f(b) > 0:
        print('f(a) et f(b) sont de même signe, donc impossible d\'utiliser TVI')
        return None
...
def main():
    while True:
        ...
        try:
            solution = madichotomie(user_function, a, b, precision, nmax)
